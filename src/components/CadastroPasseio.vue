  ...
  <div>
    ...
    <center> 
      <div class="container">
        ...
        <button class="btn btn-warning" @click="gravarPasseio">Cadastrar Serviço</button>
      </div>
    </center>
    <br>
    <Footer />
...
export default {
  ...
  mounted(){  
    ...
    .then(resp => {          
      ...
      this.passeio.usuario = this.usuario
    })
  },

  methods:{
    gravarPasseio(){
      ApiPasseio.gravarPasseio(this.passeio)
      .then(() => {          
