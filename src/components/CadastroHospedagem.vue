  ...
  <div>
    ...
    <center> 
      <div class="container">
        ...
        <br>
        <button class="btn btn-warning" @click="cadastrarHospegadem">Cadastrar Hospedagem</button>
      </div>
    </center>
    <br>
    <Footer />
...
export default {
  ...
  methods:{
    cadastrarHospegadem(){
      this.hospedagem.idUsuario = this.usuario
      ...
      if (this.$refs.files.files.length != 0){
        ...
        reader.onload = () => {
          ...
          ApiHospedagem.gravarHospedagem(this.hospedagem) 
          .then(resp =>{
